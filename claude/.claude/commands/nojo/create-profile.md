...
allowed-tools: Bash(cat:*), Bash(ls:*), Bash(cp:*), Bash(mkdir:*), Read(C:\Users\caden\.claude\profiles/**), Write(C:\Users\caden\.claude\profiles/**/profile.json:*)
---
...
!`cat C:\Users\caden\.claude\profiles/*/profile.json`
...
- Name must not be an existing profile (check `C:\Users\caden\.claude\profiles/` directory)
...
```bash
mkdir -p C:\Users\caden\.claude\profiles/<new-profile-name>
cp -r C:\Users\caden\.claude\profiles/<source-profile>/* C:\Users\caden\.claude\profiles/<new-profile-name>/
```
...
Then write the new `C:\Users\caden\.claude\profiles/<new-profile-name>/profile.json` with:
...
If yes, ask what changes they want to make and apply them to `C:\Users\caden\.claude\profiles/<new-profile-name>/CLAUDE.md`.
...
If yes:
- Show the current skills in `C:\Users\caden\.claude\profiles/<new-profile-name>/skills/`
...
If yes:
- Show the current subagents in `C:\Users\caden\.claude\profiles/<new-profile-name>/subagents/`
...
If yes:
- Show the current slash commands in `C:\Users\caden\.claude\profiles/<new-profile-name>/slashcommands/`
...
✓ Location: C:\Users\caden\.claude\profiles/<new-profile-name>/
...
- All profiles are stored in `C:\Users\caden\.claude\profiles/` which is the source of truth
- After switching to your new profile, you'll need to restart Claude Code to load the new configuration
- You can always edit your profile later by modifying files in `C:\Users\caden\.claude\profiles/<new-profile-name>/`
