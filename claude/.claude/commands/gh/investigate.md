---
description: Research a GitHub issue and propose implementation
---

Thoroughly investigate a GitHub issue, explore the codebase, and propose a technical approach.

**Usage:**
- `/investigate #123` - Investigate issue by number
- `/investigate <url>` - Investigate issue by URL

**Execution flow:**

1. **Fetch issue + comments** (delegate to gh-ops or use scripts directly)
   ```bash
