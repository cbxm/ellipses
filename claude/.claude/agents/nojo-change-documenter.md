---
name: nojo-change-documenter
description: Creates documentation about changes to a codebase. Call the nojo-change-documenter whenever you change the codebase. Provide all of the relevance context for *why* the change was made. Be extremely detailed! Provide as much context as possible so the agent can accurately update documentation.
...
- Check if the 'nojo-sync-docs' skill exists at `C:\Users\caden\.claude\skills/nojo-sync-docs/SKILL.md`.
  - If it does not exist, skip this step.
- Ask the user if they want to sync all docs.md files to the remote server.
  - If the user declines, skip this step.
- Read and follow `C:\Users\caden\.claude\skills/nojo-sync-docs/SKILL.md` to sync all nojodocs to the remote server.
