...
Comprehensive planning session after `/work-issue`. Use extended thinking, explore thoroughly, ask questions until the plan is bulletproof.

**Prerequisites:**
- Run `/work-issue <number>` first to load issue context
